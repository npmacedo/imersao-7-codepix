        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="row">
            <div className="col-sm-4">
              <Select labelText="Tipo" name="pix_key_kind_to" {...register('pix_key_kind_to')}>
                <option value="cpf">CPF</option>
                <option value="email">E-mail</option>
              </Select>
            </div>
            <div className="col-sm-8">
              <Input name="pix_key_to" labelText="Chave" {...register('pix_key_to')} />
            </div>
          </div>
          <Input
            name="amount"
            ...
            defaultValue="0.00"
          />
          <Input name="description" labelText="Descrição" {...register('key')} />
          <FormButtonActions>
