...
export class TransactionsController implements OnModuleInit, OnModuleDestroy {
    ...
    async confirmedTransaction(data){
        ...
        await this.transactionRepo.update({id:data.id},{status: TransactionStatus.completed})
